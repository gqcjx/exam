...
// 性能优化：背景缓存
let bgCache = null;         // 静态层（天空、山、地）
let decorCache = null;      // 装饰层（花、草、蘑菇、动物等）
let cacheWidth = 0;
let cacheHeight = 0;
...
function prepareBackgroundCache() {
	...
	// 使用新重构的函数绘制装饰物（已支持传入上下文）
	drawGroundDecorations(dctx);

	console.log('🖼️ 背景缓存已准备完成');
}
