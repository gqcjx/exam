...
export function generateImportTemplate(): void {
  const templateData = [
    ...
    // 示例数据
    ['张三', '小张', 'gqc@gfce.com', '13800138000', '第一中学', '高一', '1班', '123456'],
    ['李四', '小李', 'gqc@gfce.com', '13900139000', '第一中学', '高一', '2班', '123456'],
    ['王五', '', 'gqc@gfce.com', '', '第一中学', '高一', '1班', ''],
    ['赵六', '小赵', 'gqc@gfce.com', '13700137000', '', '', '', ''],
    // 说明行
    ['', '', '', '', '', '', '', ''],
    ['说明：', '', '', '', '', '', '', ''],
